...
void setInequalityConstraints(Eigen::Matrix<double, 2, 1>& xMax,
...
void castMPCToQPHessian(const Eigen::DiagonalMatrix<double, 2>& Q,
                        const Eigen::DiagonalMatrix<double, 1>& R,
                        int mpcWindow,
                        Eigen::SparseMatrix<double>& hessianMatrix)
{

    hessianMatrix.resize(2 * (mpcWindow + 1) + 1 * mpcWindow,// 2 is x length 1 is input length
...
void castMPCToQPGradient(const Eigen::DiagonalMatrix<double, 2>& Q,
...
void castMPCToQPConstraintMatrix(const Eigen::Matrix<double, 2, 2>& dynamicMatrix,
                                 const Eigen::Matrix<double, 2, 1>& controlMatrix,
                                 int mpcWindow,
...
void castMPCToQPConstraintVectors(const Eigen::Matrix<double, 2, 1>& xMax,
                                  const Eigen::Matrix<double, 2, 1>& xMin,
                                  const Eigen::Matrix<double, 1, 1>& uMax,
                                  const Eigen::Matrix<double, 1, 1>& uMin,
                                  ...
                                  Eigen::VectorXd& upperBound)
{
    ...
    Eigen::VectorXd lowerInequality
        = Eigen::MatrixXd::Zero(2 * (mpcWindow + 1) + 1 * mpcWindow, 1);
